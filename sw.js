...
const V = 'kmp-v14';
const SHELL = ['./', './index.html', './manifest.webmanifest', './config.js', './vendor/supabase.js', './demos/d1.mp3', './icons/icon-192.png', './icons/icon-512.png', './icons/favicon.svg', './icons/apple-touch-icon.png'];
